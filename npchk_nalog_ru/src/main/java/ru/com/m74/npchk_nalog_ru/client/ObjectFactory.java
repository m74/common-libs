 ...
 * generated in the ru.mixam.npchk_nalog_ru.client package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.mixam.npchk_nalog_ru.client
     * 
     */
